...
void display_tile(uint8_t start) {
  /*
    ...
    Serial.print("0x9900:");
    for (int i = 0; i < 16; i++) {
    sprintf(buf, " %02X", get_byte(0x9900 + i));
    Serial.print(buf);
    }
    Serial.println("");
    Serial.print("0x9910:");
    for (int i = 0; i < 16; i++) {
    sprintf(buf, " %02X", get_byte(0x9910 + i));
    Serial.print(buf);
    }
    Serial.println("");
    Serial.print("0x9920:");
    for (int i = 0; i < 16; i++) {
    sprintf(buf, " %02X", get_byte(0x9920 + i));
    Serial.print(buf);
    }
    Serial.println("");
    ...
    Serial.print("0x8000:");
    for (int i = 0; i < 16; i++) {
    sprintf(buf, " %02X", get_byte(0x8000 + i));
    Serial.print(buf);
    }
    Serial.println("");
    Serial.print("0x8010:");
    for (int i = 0; i < 16; i++) {
    sprintf(buf, " %02X", get_byte(0x8010 + i));
    Serial.print(buf);
    }
    Serial.println("");
    Serial.print("0x8020:");
    for (int i = 0; i < 16; i++) {
    sprintf(buf, " %02X", get_byte(0x8020 + i));
    Serial.print(buf);
    }
    Serial.println("");
    Serial.print("0x8030:");
    for (int i = 0; i < 16; i++) {
    sprintf(buf, " %02X", get_byte(0x8030 + i));
    Serial.print(buf);
    }
    Serial.println("");
    Serial.print("0x8040:");
    for (int i = 0; i < 16; i++) {
    sprintf(buf, " %02X", get_byte(0x8040 + i));
    Serial.print(buf);
    }
    Serial.println("");
    Serial.print("0x8050:");
    for (int i = 0; i < 16; i++) {
    sprintf(buf, " %02X", get_byte(0x8050 + i));
    Serial.print(buf);
    }
    Serial.println("");
  */
